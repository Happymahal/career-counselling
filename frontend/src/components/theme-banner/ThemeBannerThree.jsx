                    ...
                    <div className="row gx-4 gx-xxl-5 align-items-center">
                        <div className="col-xl-6 col-md-6">
                            <div className="theme__content__two text-md-start text-center mb-45">
                                <h4 className="hero-sub-title mb-25">Career Counseling Reimagined</h4>
                                <h1 className="main-title-two">
                                Personalized Guidance
                                    <span>Find Your Ideal Career Path with AI</span>
                                </h1>
                                <Link className="theme_btn" to="/career">VISIT THE AI CAREER COUNSELLING SYSTEM</Link>
                            </div>
                        </div>
                        <div className="col-xl-6 col-md-6">
                            <Tilt>
